...
Todas as páginas terão que seguir um padrão pré-definido. Ele segue uma estrutura semelhante a image abaixo.
...
### Observações
*Todas as informações contidas são gerados pelo ChatGPT e 4Devs*.
